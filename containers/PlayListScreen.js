   ...
   useEffect(() => {
      ...
      const getUserInfo = async () => {
         try {
            ...
            if (response0.data) {
               if (
                  response0.data !== "PlayList vide" &&
                  response0.data.length > 0
               ) {
                  setState(false);
         ...
         >
            {state ? (
               <View style={styles.playlisVide}>
                  ...
                  >
                     Pour y ajouter des histoires, cliquez sur le + dans l'angle
                     droit des illustrations de chaque épisode. Ou directement
                     de la page des séries
                  </Text>
               </View>
            ) : (
               <View
                           ...
                           <View
                              style={{
                                 ...
                                 borderBottomRightRadius:
                                    index == data.myPlaylists.length - 1
                                       ? 20
                                       : 0,
